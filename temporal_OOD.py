...
from hyperparams import get_objective_hparams, get_training_hparams, get_model_hparams
...
if __name__ == '__main__':
    ...
    model_hparams = get_model_hparams(flags.dataset, flags.hparams_seed, flags.sample_hparams)
