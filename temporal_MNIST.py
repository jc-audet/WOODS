...
if __name__ == '__main__':
    ...
    train_ds.data = train_ds.data.reshape(-1,4,28,28)
    test_ds.data = test_ds.data.reshape(-1,4,28,28)

    # With their corresponding label
    train_ds.targets = train_ds.targets.reshape(-1,4)
    test_ds.targets = test_ds.targets.reshape(-1,4)
